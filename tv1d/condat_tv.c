...
*/
void tvod_denoise(double* input, double* output, unsigned int width, const double
lambda) {
...
#ifdef _WIN32
__declspec(dllexport) void tvod_denoise(double* input, double* output, unsigned int
width, const double lambda);
#endif